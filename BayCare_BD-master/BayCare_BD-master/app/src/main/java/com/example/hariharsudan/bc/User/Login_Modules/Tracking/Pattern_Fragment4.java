...
public class Pattern_Fragment4 extends Fragment {

    String Base_url = "https://baycare-bfeee.firebaseio.com/Pills/"+ CurrentUser.Aadhar+"/";
    Firebase fb_db;

    private static RecyclerView.Adapter adapterp;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View parentView = inflater.inflate(R.layout.pattern_fragment4, container, false);
